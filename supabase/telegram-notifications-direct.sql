-- Telegram notifications for Amir's English Space.
...
-- Amir is connected to the shared Supabase through config.js.
-- To enable Telegram delivery, add a recipient after you know the required chat_id:
